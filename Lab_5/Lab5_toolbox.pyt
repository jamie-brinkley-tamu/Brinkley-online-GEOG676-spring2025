...
class GarageBuildingIntersection(object):
    ...
    def execute(self, parameters, messages):
        ...
        # Intersect our buildings with the buildings
        arcpy.Intersect_analysis([garageBuffered, buildings], gdb_path + '\Garage_Building_Intersection', 'ALL')

        arcpy.TableToTable_conversion(gdb_path + '\Garage_Building_Intersection.dbf', r'C:\Users\SuperNova\Nextcloud\GISProgramming\Lab5', '\nearbybuildings.csv')
